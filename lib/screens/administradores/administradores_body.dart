...
class AdministradoresBody extends StatelessWidget {
  const AdministradoresBody({super.key});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        var users = usuariosBloc.state.usuarios.where((e) => e.administrador != null || e.pedagogaFagundez != null).toList();
